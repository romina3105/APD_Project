...
from web_scraper import scrape_multiple_websites_sequential
...
def save_to_csv(scraped_data, filename='scraped_data.csv'):
    ...
    with open(filename, 'w', newline='', encoding='utf-8') as output_file:
        ...
        for data in scraped_data:
            writer.writerow([data.get('title', ''), data.get('price', '')])
...
def scrape_and_save(base_url):
    ...
    scraped_data, total_time = scrape_multiple_websites_sequential(urls)
